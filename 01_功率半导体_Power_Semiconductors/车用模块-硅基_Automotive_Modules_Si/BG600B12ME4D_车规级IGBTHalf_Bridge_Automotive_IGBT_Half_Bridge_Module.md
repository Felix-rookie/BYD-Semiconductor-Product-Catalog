# 比亚迪半导体 (BYD) 车规级 Half-Bridge IGBT 模块 - BG600B12ME4D
...
**BG600B12ME4D** 是一款采用先进硅基 Field Stop 技术构建的 半桥 车规级功率模块，内部集成了 IGBT 与续流二极管 (FWD) 的最优匹配。产品严格符合 **AEC-Q101** 汽车级可靠性标准，专为新能源汽车电机驱动系统 (EV Traction)、车载充电机 (OBC)、DCDC 变换器及 PTC 加热等高可靠性场景设计。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BG600B12ME4D** | 1200 V | 600 A | 2.16 V | 175 °C | 半桥 (Half-Bridge) | V-DUAL1 |
...
> *注：BG600B12ME4D 采用先进硅基 Field Stop（场终止）技术，具有低导通压降和优化的开关特性。*
>
