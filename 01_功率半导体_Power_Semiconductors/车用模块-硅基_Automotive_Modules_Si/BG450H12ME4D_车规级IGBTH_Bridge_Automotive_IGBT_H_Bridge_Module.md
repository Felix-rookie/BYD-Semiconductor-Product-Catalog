# 比亚迪半导体 (BYD) 车规级 H-Bridge IGBT 模块 - BG450H12ME4D
...
**BG450H12ME4D** 是一款采用先进硅基 Field Stop 技术构建的 H桥 车规级功率模块，内部集成了 IGBT 与续流二极管 (FWD) 的最优匹配。产品严格符合 **AEC-Q101** 汽车级可靠性标准，专为新能源汽车电机驱动系统 (EV Traction)、车载充电机 (OBC)、DCDC 变换器及 PTC 加热等高可靠性场景设计。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BG450H12ME4D** | 1200 V | 450 A | 2.16 V | 175 °C | H桥 (H-Bridge) | V-DUAL1 |
...
| 开通损耗 | E<sub>on</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 125 °C<br>T<sub>j</sub> = 150 °C | -<br>-<br>- | 45<br>60<br>70 | -<br>-<br>- | mJ |
| 关断损耗 | E<sub>off</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 125 °C<br>T<sub>j</sub> = 150 °C | -<br>-<br>- | 33<br>47<br>50 | -<br>-<br>- | mJ |
...
> *注：BG450H12ME4D 采用先进硅基 Field Stop（场终止）技术，具有低导通压降和优化的开关特性。*
>
