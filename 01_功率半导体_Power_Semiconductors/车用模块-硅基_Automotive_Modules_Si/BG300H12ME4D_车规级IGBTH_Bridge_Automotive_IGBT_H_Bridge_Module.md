# 比亚迪半导体 (BYD) 车规级 H-Bridge IGBT 模块 - BG300H12ME4D
...
**BG300H12ME4D** 是一款采用先进硅基 Field Stop 技术构建的 H桥 车规级功率模块，内部集成了 IGBT 与续流二极管 (FWD) 的最优匹配。产品严格符合 **AEC-Q101** 汽车级可靠性标准，专为新能源汽车电机驱动系统 (EV Traction)、车载充电机 (OBC)、DCDC 变换器及 PTC 加热等高可靠性场景设计。

### 🌟 核心特性 (Features)
* **车规认证**：严格符合 AEC-Q101 车规级标准要求
* **大功率H桥拓扑**：工业标准V-DUAL1外壳设计，内部H-Bridge拓扑，优化电气连接
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BG300H12ME4D** | 1200 V | 300 A | 2.1 V | 175 °C | H桥 (H-Bridge) | V-DUAL1 |
...
| 总耗散功率 | P<sub>tot</sub> | T<sub>C</sub> = 25 °C，每 IGBT 晶圆 | 3571 | W |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| IGBT 结-管壳热阻 | R<sub>th(j-c)</sub> | 每个独立 IGBT 的导热热阻 | - | 0.042 | - | °C/W |
| 二极管结-管壳热阻 | R<sub>th(j-c)</sub> | 每个独立二极管的导热热阻 | - | 0.075 | - | °C/W |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 集电极-发射极饱和压降 | V<sub>CE(sat)</sub> | V<sub>GE</sub> = 15 V, I<sub>C</sub> = 300 A, T<sub>j</sub> = 25 °C<br>V<sub>GE</sub> = 15 V, T<sub>j</sub> = 125 °C<br>V<sub>GE</sub> = 15 V, T<sub>j</sub> = 150 °C | -<br>-<br>- | 2.1<br>2.3<br>2.33 | —<br>-<br>- | V |
...
| 断态集电极漏电流 | I<sub>CES</sub> | V<sub>CE</sub> = V<sub>CES</sub>, V<sub>GE</sub> = 0 V | - | - | 0.4 | mA |
| 门极充电电量 | Q<sub>g</sub> | V<sub>GE</sub> = ±15 V | - | 1.8 | - | μC |
| 内部门极电阻 | R<sub>Gint</sub> | T<sub>j</sub> = 25 °C | - | 1.3 | - | Ω |
| 输入电容 | C<sub>ies</sub> | f = 1 MHz, V<sub>CE</sub> = 25 V, V<sub>GE</sub> = 0 V | - | 17 | - | nF |
| 反向传输电容 | C<sub>res</sub> | f = 1 MHz, V<sub>CE</sub> = 25 V, V<sub>GE</sub> = 0 V | - | 0.8 | - | nF |

### 2. IGBT 开关特性 (IGBT-Inverter, 感性负载)

测试条件：V<sub>CC</sub> = 600 V, I<sub>C</sub> = 300 A, V<sub>GE</sub> = ±15 V, R<sub>Gon</sub> = 1.0 Ω, R<sub>Goff</sub> = 1.0 Ω

| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 最小值 | 典型值 | 最大值 | 单位 |
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 开通延迟时间 | t<sub>d(on)</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 125 °C<br>T<sub>j</sub> = 150 °C | -<br>-<br>- | 125<br>—<br>— | -<br>-<br>- | ns |
...
| 开通损耗 | E<sub>on</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 125 °C<br>T<sub>j</sub> = 150 °C | -<br>-<br>- | 45<br>55<br>60 | -<br>-<br>- | mJ |
| 关断损耗 | E<sub>off</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 125 °C<br>T<sub>j</sub> = 150 °C | -<br>-<br>- | 15<br>24<br>29 | -<br>-<br>- | mJ |
...
| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 最小值 | 典型值 | 最大值 | 单位 |
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 正向导通压降 | V<sub>F</sub> | I<sub>F</sub> = 300 A, V<sub>GE</sub> = 0 V, T<sub>j</sub> = 25 °C<br>I<sub>F</sub> = 300 A, T<sub>j</sub> = 150 °C | -<br>- | 2.0<br>2.2 | —<br>- | V |
| 反向恢复峰值电流 | I<sub>RM</sub> | 测试条件同开关特性 | - | 100 | - | A |
| 反向恢复电荷 | Q<sub>rr</sub> | 测试条件同开关特性 | - | 42 | - | μC |
| 反向恢复损耗 | E<sub>rec</sub> | 测试条件同开关特性 | - | 30 | - | mJ |
...
> *注：BG300H12ME4D 采用先进硅基 Field Stop（场终止）技术，具有低导通压降和优化的开关特性。*
>
