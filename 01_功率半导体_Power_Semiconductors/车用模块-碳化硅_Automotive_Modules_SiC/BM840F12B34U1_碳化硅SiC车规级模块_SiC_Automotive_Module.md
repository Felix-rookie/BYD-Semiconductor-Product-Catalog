# 比亚迪半导体 (BYD) 车规级碳化硅 (SiC) 半桥模块 - BM840F12B34U1
...
**BM840F12B34U1** 是一款基于第三代宽禁带 **碳化硅 (SiC) MOSFET** 技术构建的高性能车规级功率模块。采用先进的 SiC MOSFET 工艺，具有极低的导通电阻、超低的开关损耗及卓越的高温工作能力。产品严格符合 **AEC-Q101** 标准，专为纯电/混动车主驱逆变器 (EV/HEV Traction Inverter) 设计，可显著提升系统效率与功率密度。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BM840F12B34U1** | 1200 V | 840 A | 2.7 mΩ | 175 °C | 半桥模块 (Half-Bridge) | 标准模块封装 (PinFin Base Plate) |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 漏-源极击穿电压 | V<sub>(BR)DSS</sub> | V<sub>GS</sub> = 0 V, I<sub>D</sub> = 30 mA | 1200 | - | - | V |
| 漏-源极导通电阻 | R<sub>DS(on)</sub> | V<sub>GS</sub> = 18 V, I<sub>D</sub> = 360 A, T<sub>j</sub> = 25 °C<br>V<sub>GS</sub> = 18 V, T<sub>j</sub> = 150 °C | - | 2.7<br>4.4 | 3.8<br>- | mΩ |
| 栅极阈值电压 | V<sub>GS(th)</sub> | V<sub>DS</sub> = V<sub>GS</sub>, I<sub>D</sub> = [电流] mA | 2.1 | — | 4.5 | V |
| 栅极漏电流 | I<sub>GSS</sub> | V<sub>GS</sub> = ±20 V | - | - | 100 | nA |
| 漏极截止电流 | I<sub>DSS</sub> | V<sub>DS</sub> = V<sub>DSS</sub>, V<sub>GS</sub> = 0 V | - | - | 150 | μA |
| 体二极管正向电压 | V<sub>SD</sub> | V<sub>GS</sub> = 0 V, I<sub>F</sub> = [电流] A | - | 3.4 | 5.8 | V |
| 门极总电荷 | Q<sub>g</sub> | V<sub>GS</sub> = [-5 ~ 18] V | - | 0.93 | - | μC |
| 内部门极电阻 | R<sub>Gint</sub> | - | - | 1.9 | - | Ω |
| 输入电容 | C<sub>iss</sub> | V<sub>DS</sub> = [电压] V, f = 1 MHz | - | 3600 | - | pF |
| 输出电容 | C<sub>oss</sub> | V<sub>DS</sub> = [电压] V, f = 1 MHz | - | 167 | - | pF |
| 反向传输电容 | C<sub>rss</sub> | V<sub>DS</sub> = [电压] V, f = 1 MHz | - | 30 | - | pF |

### 2. SiC MOSFET 开关特性 (感性负载)

测试条件：V<sub>DD</sub> = 600 V, I<sub>D</sub> = 500 A, V<sub>GS</sub> = -4/+18, R<sub>G(on)</sub> = 2.25 Ω, R<sub>G(off)</sub> = 10 Ω

| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 典型值 | 单位 |
| :--- | :---: | :--- | :---: | :---: |
| 开通延迟时间 | t<sub>d(on)</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 86<br>73 | ns |
| 上升时间 | t<sub>r</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 83<br>71 | ns |
| 关断延迟时间 | t<sub>d(off)</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 375<br>477 | ns |
| 下降时间 | t<sub>f</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 63<br>70 | ns |
| 开通损耗 | E<sub>on</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 24<br>16 | mJ |
| 关断损耗 | E<sub>off</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 45<br>34 | mJ |
