# 比亚迪半导体 (BYD) 碳化硅 (SiC) 车规级功率模块 - BME840F12B34U5S-D
...
**BME840F12B34U5S-D** 是一款基于第三代半导体材料——碳化硅 (SiC) 的功率模块，采用先进的 SiC MOSFET 芯片，具有低损耗和低寄生电感。采用银烧结工艺、直接冷却铜 PinFin 底板和高性能氮化硅陶瓷绝缘。最高支持 800V 电压平台。
...
| 总耗散功率 | $P_{tot}$ | $T_F = 65^\circ\text{C}$ | 1000 | W |
| 栅极-源极峰值电压 (瞬态) | $V_{GS}$ | $t_p < 1\mu\text{s}$ | $\pm$见规格书 | V |
| 栅极-源极电压 (最大值) | $V_{GSmax}$ | - | -10/+20 | V |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 漏极-源极导通电阻 | $R_{DS(on)}$ | $V_{GS}=18\text{V}, I_D=I_D=360A, V_GS=18V, T_j=25^\circ\text{C}$<br>$V_{GS}=18\text{V}, I_D=I_D=360A, V_GS=18V, T_j=175^\circ\text{C}$ | -<br>- | 3.7<br>6.0 (175°C) | 4.5<br>- | mΩ<br>mΩ |
| 漏极-源极击穿电压 | $V_{BR(DSS)}$ | $V_{GS}=0\text{V}, I_D=1\text{mA}$ | 1200 | - | - | V |
| 栅极-源极阈值电压 | $V_{GS(th)}$ | $I_D=$按规格书, $V_{DS}=V_{GS}, T_j=25^\circ\text{C}$ | 2.1 | 2.5 | 4.5 | V |
...
| 门极充电电量-源极 | $Q_{gs}$ | $V_{DS}=850\text{V}, V_{GS}=-5~18\text{V}$ | - | 198 | - | nC |
| 门极充电电量-漏极 | $Q_{gd}$ | $V_{DS}=850\text{V}, V_{GS}=-5~18\text{V}$ | - | 204 | - | nC |
| 门极总电量 | $Q_g$ | $V_{DS}=850\text{V}, V_{GS}=-5~18\text{V}$ | - | 744 | - | nC |
| 内部栅极电阻 | $R_{Gint}$ | $T_j=25^\circ\text{C}, f=1\text{MHz}$ | - | 1.9 | - | $\Omega$ |
| 输入电容 | $C_{iss}$ | $f=1\text{MHz}, T_j=25^\circ\text{C}, V_{DS}=850\text{V}$ | - | 19824 (pF) | - | nF |
| 输出电容 | $C_{oss}$ | $f=1\text{MHz}, T_j=25^\circ\text{C}, V_{DS}=850\text{V}$ | - | 1470 (pF) | - | nF |
| 反向传输电容 | $C_{rss}$ | $f=1\text{MHz}, T_j=25^\circ\text{C}, V_{DS}=850\text{V}$ | - | 78 (pF) | - | pF |
