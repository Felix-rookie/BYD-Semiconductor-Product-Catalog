# 比亚迪半导体 (BYD) 碳化硅 (SiC) 车规级功率模块 - BM1040F12B34U2
...
**BM1040F12B34U2** 是一款基于第三代半导体材料——碳化硅 (SiC) 的功率模块，采用先进的 SiC MOSFET 芯片，具有低损耗和高短路能力，在 1-30kHz 频率的应用中表现出优良的性能。采用银烧结工艺、直接冷却铜 PinFin 底板和高性能氮化硅陶瓷绝缘。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BM1040F12B34U2** | 1200 V | 1040 A | 1.7 mΩ | 175 °C | 半桥模块 (Half-Bridge) | 标准模块封装 (PinFin Base Plate) |
...
| 连续漏极直流电流 | $I_{D(nom)}$ | $T_F = 65^\circ\text{C}, T_{vjmax} = 175^\circ\text{C}$ | 1040 | A |
| 脉冲漏极电流 | $I_{D(pulse)}$ | 脉宽受限，符合 $T_{jmax}$ | 2000 | A |
| 总耗散功率 | $P_{tot}$ | $T_F = 65^\circ\text{C}$ | 1222 | W |
...
| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 额定值 | 单位 |
| :--- | :---: | :--- | :---: | :---: |
| 体二极管连续正向电流 | $I_{SD}$ | 等同于 $I_{D(nom)}$ | 1040 | A |
| 体二极管脉冲正向电流 | $I_{SD(pulse)}$ | 脉宽受限，符合 $T_{jmax}$ | 2000 | A |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| MOSFET 结-冷却液热阻 | $R_{th(j-f)}$ | 每个 MOSFET，$\Delta V/\Delta t$ 按规格书 | - | 0.09 | - | °C/W |
| 杂散电感 | $L_{sCE}$ | 模块内部 | - | 15 | - | nH |
| 模块引线电阻 | $R_{CC'+EE'}$ | 端子到芯片，每开关 | - | — | - | mΩ |
| 端子螺丝紧固扭矩 | $M$ | 功率端子 M5 安装力矩 | — | — | 3.0~6.0 | $\text{N}\cdot\text{m}$ |
| 基板安装紧固扭矩 | $M$ | 模块到底板固定螺钉 M4 | 1.8 | 2.0 | 2.5 | $\text{N}\cdot\text{m}$ |
| 重量 | $W$ | 模块整体产品克重 | - | 680 | - | g |
| 外形尺寸 | $L \times W \times H$ | 典型值 | - | 154.5×126.5×29.5 | - | mm |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 漏极-源极导通电阻 | $R_{DS(on)}$ | $V_{GS}=18\text{V}, I_D=I_D=480A, V_GS=18V, T_j=25^\circ\text{C}$<br>$V_{GS}=18\text{V}, I_D=I_D=480A, V_GS=18V, T_j=175^\circ\text{C}$ | -<br>- | 1.7<br>4.0 (175°C) | 2.8<br>- | mΩ<br>mΩ |
...
| 门极充电电量-源极 | $Q_{gs}$ | $V_{DS}=850\text{V}, V_{GS}=-5~18\text{V}$ | - | 592 | - | nC |
| 门极充电电量-漏极 | $Q_{gd}$ | $V_{DS}=850\text{V}, V_{GS}=-5~18\text{V}$ | - | 320 | - | nC |
| 门极总电量 | $Q_g$ | $V_{DS}=850\text{V}, V_{GS}=-5~18\text{V}$ | - | 1520 | - | nC |
| 内部栅极电阻 | $R_{Gint}$ | $T_j=25^\circ\text{C}, f=1\text{MHz}$ | - | 1.4 | - | $\Omega$ |
| 输入电容 | $C_{iss}$ | $f=1\text{MHz}, T_j=25^\circ\text{C}, V_{DS}=850\text{V}$ | - | 32 (nF) | - | nF |
| 输出电容 | $C_{oss}$ | $f=1\text{MHz}, T_j=25^\circ\text{C}, V_{DS}=850\text{V}$ | - | 1.84 (nF) | - | nF |
| 反向传输电容 | $C_{rss}$ | $f=1\text{MHz}, T_j=25^\circ\text{C}, V_{DS}=850\text{V}$ | - | 176 (pF) | - | pF |
...
| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 最小值 | 典型值 | 最大值 | 单位 |
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 源极-漏极正向导通压降 | $V_{SD}$ | I_SD=1040A, $T_j=25^\circ\text{C}$<br>I_SD=1040A, $T_j=175^\circ\text{C}$ | -<br>- | 4.6 (1040A)<br>— | -<br>- | V<br>V |
| 反向恢复峰值电流 | $I_{rrm}$ | $I_F$按规格书, $V_{DS}$按规格书, $T_j=175^\circ\text{C}$ | - | 222 (175°C) | - | A |
| 反向恢复电荷 | $Q_{rr}$ | $I_F$按规格书, $V_{DS}$按规格书, $T_j=175^\circ\text{C}$ | - | 8 (nC) | - | nC |
| 反向恢复时间 | $t_{rr}$ | $I_F$按规格书, $V_{DS}$按规格书, $T_j=175^\circ\text{C}$ | - | 62 | - | ns |
| 反向恢复损耗能量 | $E_{rr}$ | $I_F$按规格书, $T_j=175^\circ\text{C}$ | - | 1.0 (175°C) | - | mJ |
