# 比亚迪半导体 (BYD) 车规级碳化硅 (SiC) 半桥模块 - BM700F12B34U4
...
**BM700F12B34U4** 是一款基于第三代宽禁带 **碳化硅 (SiC) MOSFET** 技术构建的高性能车规级功率模块。采用先进的 SiC MOSFET 工艺，具有极低的导通电阻、超低的开关损耗及卓越的高温工作能力。产品严格符合 **AEC-Q101** 标准，专为纯电/混动车主驱逆变器 (EV/HEV Traction Inverter) 设计，可显著提升系统效率与功率密度。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BM700F12B34U4** | 1200 V | 700 A | 2.75 mΩ | 175 °C | 半桥模块 (Half-Bridge) | 标准模块封装 (PinFin Base Plate) |
...
| 连续漏极电流 | I<sub>D</sub> | T<sub>C</sub> = 65 °C | 700 | A |
| 脉冲漏极电流 | I<sub>DM</sub> | 脉宽受限，符合 T<sub>jmax</sub> | 1400 | A |
| 总耗散功率 | P<sub>tot</sub> | T<sub>C</sub> = 25 °C | 910 | W |
...
| :--- | :---: | :--- | :---: | :---: |
| 结-管壳热阻（每 SiC MOSFET） | R<sub>th(j-c)</sub> | - | 0.12 | °C/W |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 漏-源极击穿电压 | V<sub>(BR)DSS</sub> | V<sub>GS</sub> = 0 V, I<sub>D</sub> = 5 mA | 1200 | - | - | V |
| 漏-源极导通电阻 | R<sub>DS(on)</sub> | V<sub>GS</sub> = 18 V, I<sub>D</sub> = 300 A, T<sub>j</sub> = 25 °C<br>V<sub>GS</sub> = 18 V, T<sub>j</sub> = 150 °C | - | 2.75<br>6.6 | 4.4<br>- | mΩ |
...
| 门极总电荷 | Q<sub>g</sub> | V<sub>GS</sub> = [-5 ~ 18] V | - | 0.86 | - | μC |
| 内部门极电阻 | R<sub>Gint</sub> | - | - | 2.3 | - | Ω |
...
测试条件：V<sub>DD</sub> = 600 V, I<sub>D</sub> = 400 A, V<sub>GS</sub> = -4/+18, R<sub>G(on)</sub> = 5 Ω, R<sub>G(off)</sub> = 8 Ω

| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 典型值 | 单位 |
| :--- | :---: | :--- | :---: | :---: |
| 开通延迟时间 | t<sub>d(on)</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 104<br>76 | ns |
| 上升时间 | t<sub>r</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 80<br>52 | ns |
| 关断延迟时间 | t<sub>d(off)</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 328<br>385 | ns |
| 下降时间 | t<sub>f</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 54<br>59 | ns |
| 开通损耗 | E<sub>on</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 19<br>16 | mJ |
| 关断损耗 | E<sub>off</sub> | T<sub>j</sub> = 25 °C<br>T<sub>j</sub> = 150 °C | 24<br>27 | mJ |
