# 比亚迪半导体 (BYD) 工业级 IGBT半桥模块 - BG75B12UX4-I
...
**BG75B12UX4-I** 是一款采用高性能 IGBT 芯片、FRD 芯片和优化电气连接设计的硅基工业级 IGBT 半桥模块。该模块具有低导通损耗、低开关损耗和高短路耐量，适用于工业变频器、服伺系统和 UPS 等高可靠性功率变换场景。

### 🌟 核心特性 (Features)
* **半桥拓扑**：工业级半桥模块 (Half-bridge module)，额定 V<sub>CE</sub>=1200 V、I<sub>C</sub>=75 A。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BG75B12UX4-I** | 1200 V | 75 A | — V | 175 °C | 半桥 (Half-Bridge) | 34mm Industrial |
...
| 栅极阈值电压 | V<sub>GE(th)</sub> | V<sub>CE</sub>=V<sub>GE</sub>, I<sub>C</sub>=3 mA, T<sub>vj</sub>=25 °C | — | — | — | V |
| 栅极电荷 | Q<sub>G</sub> | V<sub>GE</sub>=-15 V … +15 V | — | — | — | μC |
| 内部栅极电阻 | R<sub>gint</sub> | T<sub>vj</sub>=25 °C | — | — | — | Ω |
...
| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 最小值 | 典型值 | 最大值 | 单位 |
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 正向电压 | V<sub>F</sub> | I<sub>F</sub>=75 A, V<sub>GE</sub>=0 V, T<sub>vj</sub>=25 °C<br>I<sub>F</sub>=75 A, V<sub>GE</sub>=0 V, T<sub>vj</sub>=150 °C | -<br>- | 600<br>— | —<br>- | V |
| 恢复电荷 | Q<sub>rr</sub> | I<sub>F</sub>=75 A, V<sub>R</sub>=600 V, -di<sub>F</sub>/dt=— A/μs, T<sub>vj</sub>=125 °C | — | 5 | — | μC |
| 反向恢复损耗 | E<sub>rec</sub> | I<sub>F</sub>=75 A, V<sub>R</sub>=600 V, -di<sub>F</sub>/dt=— A/μs, T<sub>vj</sub>=125 °C | — | 5 | — | mJ |
