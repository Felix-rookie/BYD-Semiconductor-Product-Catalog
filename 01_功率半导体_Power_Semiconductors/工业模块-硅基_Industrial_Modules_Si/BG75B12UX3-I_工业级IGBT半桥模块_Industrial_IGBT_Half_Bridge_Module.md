# 比亚迪半导体 (BYD) 工业级 IGBT半桥模块 - BG75B12UX3-I
...
**BG75B12UX3-I** 是一款采用高性能 IGBT 芯片、FRD 芯片和优化电气连接设计的硅基工业级 IGBT 半桥模块。该模块具有低导通损耗、低开关损耗和高短路耐量，适用于工业变频器、服伺系统和 UPS 等高可靠性功率变换场景。

### 🌟 核心特性 (Features)
* **半桥拓扑**：工业级半桥模块 (Half-bridge module)，额定 V<sub>CE</sub>=5 V、I<sub>C</sub>=75 A。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BG75B12UX3-I** | 5 V | 75 A | — V | 150 °C | 半桥 (Half-Bridge) | 34mm Industrial |
...
| 连续集电极直流电流 | I<sub>C</sub> | T<sub>C</sub>=80 °C, T<sub>vj</sub>=150 °C | 75 | A |
...
| 总耗散功率 | P<sub>tot</sub> | T<sub>C</sub>=25 °C, T<sub>vj</sub>=150 °C | — | W |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| IGBT 结-外壳热阻 | R<sub>th(j-c)</sub> | 每个独立 IGBT (per IGBT) | — | 0.03 | — | K/W |
| 二极管 结-外壳热阻 | R<sub>th(j-c)</sub> | 每个独立二极管 (per diode) | — | — | — | K/W |
...
测试条件：I<sub>C</sub>=75 A, V<sub>CE</sub>=2 V, V<sub>GE</sub>=-15 V … +15 V, R<sub>G</sub>=— Ω
...
| 恢复电荷 | Q<sub>rr</sub> | I<sub>F</sub>=75 A, V<sub>R</sub>=2 V, -di<sub>F</sub>/dt=550 A/μs, T<sub>vj</sub>=125 °C | — | 10 | — | μC |
| 反向恢复损耗 | E<sub>rec</sub> | I<sub>F</sub>=75 A, V<sub>R</sub>=2 V, -di<sub>F</sub>/dt=550 A/μs, T<sub>vj</sub>=125 °C | — | 10 | — | mJ |
