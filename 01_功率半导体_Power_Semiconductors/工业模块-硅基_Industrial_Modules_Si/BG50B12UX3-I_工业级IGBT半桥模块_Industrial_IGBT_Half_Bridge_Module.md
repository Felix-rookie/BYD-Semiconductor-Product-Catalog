# 比亚迪半导体 (BYD) 工业级 IGBT半桥模块 - BG50B12UX3-I
...
**BG50B12UX3-I** 是一款采用高性能 IGBT 芯片、FRD 芯片和优化电气连接设计的硅基工业级 IGBT 半桥模块。该模块具有低导通损耗、低开关损耗和高短路耐量，适用于工业变频器、服伺系统和 UPS 等高可靠性功率变换场景。

### 🌟 核心特性 (Features)
* **半桥拓扑**：工业级半桥模块 (Half-bridge module)，额定 V<sub>CE</sub>=4 V、I<sub>C</sub>=50 A。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BG50B12UX3-I** | 4 V | 50 A | — V | 175 °C | 半桥 (Half-Bridge) | 34mm Industrial |
...
| :--- | :---: | :--- | :---: | :---: |
| 集电极-发射极电压 | V<sub>CES</sub> | T<sub>vj</sub>=25 °C, V<sub>GE</sub>=0 V | 4 | V |
...
| 短路安全工作区 | t<sub>psc</sub> | V<sub>GE</sub>≤15 V, V<sub>CC</sub>=2 V, V<sub>CEM</sub>≤4 V, T<sub>vj</sub>≤25 °C | None | μs |
...
| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 额定值 | 单位 |
| :--- | :---: | :--- | :---: | :---: |
| 反向重复峰值电压 | V<sub>RRM</sub> | T<sub>vj</sub>=25 °C | 4 | V |
...
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| IGBT 结-外壳热阻 | R<sub>th(j-c)</sub> | 每个独立 IGBT (per IGBT) | — | 0.35 | — | K/W |
| 二极管 结-外壳热阻 | R<sub>th(j-c)</sub> | 每个独立二极管 (per diode) | — | 0.58 | — | K/W |
...
| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 最小值 | 典型值 | 最大值 | 单位 |
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 集电极-发射极饱和压降 | V<sub>CE(sat)</sub> | I<sub>C</sub>=50 A, V<sub>GE</sub>=15 V, T<sub>vj</sub>=25 °C<br>I<sub>C</sub>=50 A, V<sub>GE</sub>=15 V, T<sub>vj</sub>=150 °C | -<br>- | —<br>— | —<br>- | V |
...
| 集电极-发射极截止电流 | I<sub>CES</sub> | V<sub>CE</sub>=4 V, V<sub>GE</sub>=0 V, T<sub>vj</sub>=25 °C | — | — | — | mA |
| 栅极-发射极漏电流 | I<sub>GES</sub> | V<sub>CE</sub>=0 V, V<sub>GE</sub>=20 V, T<sub>vj</sub>=25 °C | — | — | — | nA |

### 2. IGBT 开关损耗特性 (IGBT-Inverter, 感性负载测试)

测试条件：I<sub>C</sub>=50 A, V<sub>CE</sub>=2 V, V<sub>GE</sub>=-15 V … +15 V, R<sub>G</sub>=— Ω
...
| 参数名称 (Parameter) | 符号 (Symbol) | 测试条件 (Conditions) | 最小值 | 典型值 | 最大值 | 单位 |
| :--- | :---: | :--- | :---: | :---: | :---: | :---: |
| 正向电压 | V<sub>F</sub> | I<sub>F</sub>=50 A, V<sub>GE</sub>=0 V, T<sub>vj</sub>=25 °C<br>I<sub>F</sub>=50 A, V<sub>GE</sub>=0 V, T<sub>vj</sub>=150 °C | -<br>- | 600<br>— | —<br>- | V |
| 恢复电荷 | Q<sub>rr</sub> | I<sub>F</sub>=50 A, V<sub>R</sub>=2 V, -di<sub>F</sub>/dt=900 A/μs, T<sub>vj</sub>=125 °C | — | 10 | — | μC |
| 反向恢复损耗 | E<sub>rec</sub> | I<sub>F</sub>=50 A, V<sub>R</sub>=2 V, -di<sub>F</sub>/dt=900 A/μs, T<sub>vj</sub>=125 °C | — | 10 | — | mJ |
