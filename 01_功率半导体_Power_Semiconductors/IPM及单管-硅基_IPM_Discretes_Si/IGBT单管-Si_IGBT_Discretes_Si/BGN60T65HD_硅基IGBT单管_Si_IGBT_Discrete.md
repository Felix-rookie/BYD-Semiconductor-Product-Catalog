# 比亚迪半导体 (BYD) 工业级 IGBT 单管 - BGN60T65HD
...
**BGN60T65HD** 是一款基于先进 TrenchFS 技术（Trench Field-Stop Technology）构建的高性能、高可靠性 IGBT 单管，内部集成了软快恢复反并联二极管。本产品为工业级标准，专为 UPS、PFC、焊机及工业电源等高频应用设计。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BGN60T65HD** | 650 V | 60 A | 1.7 V | 175 °C | 60T65HD | TO247-3 |
...
| 连续集电极电流 (T<sub>C</sub> = 25 °C) | I<sub>C</sub> | 120 | A |
| 连续集电极电流 (T<sub>C</sub> = 100 °C) | I<sub>C</sub> | 60 | A |
| 集电极脉冲电流 (脉宽受 T<sub>jmax</sub> 限制) | I<sub>Cpuls</sub> | 240 | A |
| 二极管正向直流电流 (T<sub>C</sub> = 25 °C) | I<sub>F</sub> | 120 | A |
| 二极管正向直流电流 (T<sub>C</sub> = 100 °C) | I<sub>F</sub> | 60 | A |
| 二极管脉冲电流 | I<sub>Fpuls</sub> | 240 | A |
| 栅极-发射极电压 | V<sub>GE</sub> | ± 20 | V |
| 短路耐受时间 (V<sub>GE</sub>=15 V, V<sub>CC</sub>≤400 V, T<sub>j</sub>≤150 °C) | t<sub>sc</sub> | 5 | μs |
| 总耗散功率 (T<sub>C</sub> = 25 °C) | P<sub>tot</sub> | 333 | W |
...
| :--- | :---: | :---: | :---: |
| IGBT 结-管壳热阻 | R<sub>th(j-c)</sub> | 0.45 | °C/W |
...
| 集电极-发射极饱和电压 | V<sub>CE(sat)</sub> | V<sub>GE</sub>=15 V, I<sub>C</sub>=60 A, T<sub>j</sub>=25 °C<br>V<sub>GE</sub>=15 V, I<sub>C</sub>=60 A, T<sub>j</sub>=150 °C | - | 1.7<br>2.1 | 2.2<br>- | V |
| 二极管正向导通电压 | V<sub>F</sub> | V<sub>GE</sub>=0 V, I<sub>F</sub>=60 A, T<sub>j</sub>=25 °C<br>V<sub>GE</sub>=0 V, I<sub>F</sub>=60 A, T<sub>j</sub>=150 °C | - | 1.6<br>1.4 | 2.5<br>- | V |
| 栅极-发射极阈值电压 | V<sub>GE(th)</sub> | I<sub>C</sub>=1 mA, V<sub>CE</sub>=V<sub>GE</sub> | 5.0 | 5.8 | 7.0 | V |
...
| :--- | :---: | :--- | :---: | :---: |
| 输入电容 | C<sub>ies</sub> | V<sub>CE</sub>=25 V, V<sub>GE</sub>=0 V, f=1 MHz | 7648 | pF |
| 输出电容 | C<sub>oes</sub> | V<sub>CE</sub>=25 V, V<sub>GE</sub>=0 V, f=1 MHz | 264 | pF |
| 反向传输电容 | C<sub>res</sub> | V<sub>CE</sub>=25 V, V<sub>GE</sub>=0 V, f=1 MHz | 156 | pF |
| 门极总电量 | Q<sub>G</sub> | V<sub>CC</sub>=400 V, I<sub>C</sub>=40 A, V<sub>GE</sub>=15 V | 317 | nC |
| 内部发射极电感 | L<sub>E</sub> | - | - | nH |
| 短路电流 | I<sub>C(sc)</sub> | V<sub>CC</sub>=400 V, V<sub>GE</sub>=15 V, T<sub>j</sub>=150 °C | 320 | A |
| 反偏安全工作区 | RBSOA | - | - | A |
...
测试条件：V<sub>CC</sub>=400 V, I<sub>C</sub>=60 A, V<sub>GE</sub>=-7.5/15 V, R<sub>G</sub>=10 Ω

| 参数分类 | 参数名称 (Parameter) | 符号 (Symbol) | 典型值 (Typ.) | 单位 (Unit) |
| :--- | :--- | :---: | :---: | :---: |
| **IGBT 特性** | 开通延迟时间 (Turn-on delay time) | t<sub>d(on)</sub> | 65 | ns |
| | 上升时间 (Rise time) | t<sub>r</sub> | 90 | ns |
| | 关断延迟时间 (Turn-off delay time) | t<sub>d(off)</sub> | 75 | ns |
| | 下降时间 (Fall time) | t<sub>f</sub> | 30 | ns |
| | 开通损耗 (Turn-on energy)* | E<sub>on</sub> | 1.86 | mJ |
| | 关断损耗 (Turn-off energy) | E<sub>off</sub> | 0.33 | mJ |
| | 总开关损耗 (Total switching energy) | E<sub>ts</sub> | 2.19 | mJ |
| **反并联二极管** | 反向恢复时间 (Reverse recovery time) | t<sub>rr</sub> | 135 | ns |
| | 恢复电荷 (Recovered charge) | Q<sub>rr</sub> | 2.4 | μC |
| | 反向恢复峰值电流 (Peak reverse recovery current) | I<sub>RM</sub> | 11 | A |
| | 反向恢复损耗 (Reverse recovered energy) | E<sub>rec</sub> | 0.17 | mJ |
...
| 参数分类 | 参数名称 (Parameter) | 符号 (Symbol) | 典型值 (Typ.) | 单位 (Unit) |
| :--- | :--- | :---: | :---: | :---: |
| **IGBT 特性** | 开通延迟时间 (Turn-on delay time) | t<sub>d(on)</sub> | 60 | ns |
| | 上升时间 (Rise time) | t<sub>r</sub> | 85 | ns |
| | 关断延迟时间 (Turn-off delay time) | t<sub>d(off)</sub> | 115 | ns |
| | 下降时间 (Fall time) | t<sub>f</sub> | 25 | ns |
| | 开通损耗 (Turn-on energy)* | E<sub>on</sub> | 2.65 | mJ |
| | 关断损耗 (Turn-off energy) | E<sub>off</sub> | 0.61 | mJ |
| | 总开关损耗 (Total switching energy) | E<sub>ts</sub> | 3.26 | mJ |
| **反并联二极管** | 反向恢复时间 (Reverse recovery time) | t<sub>rr</sub> | 225 | ns |
| | 恢复电荷 (Recovered charge) | Q<sub>rr</sub> | 5.1 | μC |
| | 反向恢复峰值电流 (Peak reverse recovery current) | I<sub>RM</sub> | 25 | A |
| | 反向恢复损耗 (Reverse recovered energy) | E<sub>rec</sub> | 0.27 | mJ |
