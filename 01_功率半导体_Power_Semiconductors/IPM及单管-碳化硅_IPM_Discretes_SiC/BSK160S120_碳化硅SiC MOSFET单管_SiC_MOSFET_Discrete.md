# 比亚迪半导体 (BYD) 碳化硅 (SiC) MOSFET 单管 - BSK160S120
...
**BSK160S120** 是一款专为汽车应用设计的碳化硅 (SiC) 功率 MOSFET，采用先进的工艺技术，实现极低的单位面积导通电阻。该器件适用于高频应用，具有出色的开关性能和可靠性。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **BSK160S120** | 1200 V | 98 A | 160 mΩ | 175 °C | BSK160S120 | TO-247-4 |
...
| 连续漏极电流 ($T_C = 25^\circ\text{C}$) | $I_D$ | 98 | A |
| 连续漏极电流 ($T_C = 100^\circ\text{C}$) | $I_D$ | 64 | A |
| 脉冲漏极电流 (脉宽受 $T_{jmax}$ 限制) | $I_{D(pulse)}$ | 167 | A |
| 栅极-源极电压 (最大值) | $V_{GSmax}$ | -10/+25 | V |
| 栅极-源极电压 (推荐工作) | $V_{GS}$ | -5/+20 | V |
| 总耗散功率 ($T_C = 25^\circ\text{C}$) | $P_D$ | 195 | W |
| 最高结温 | $T_{jmax}$ | 175 | °C |
...
| :--- | :---: | :---: | :---: |
| MOSFET 结-管壳热阻 | $R_{\theta JC}$ | 0.77 | °C/W |
...
| 漏极-源极导通电阻 | $R_{DS(on)}$ | V_GS=20V, I_D=16A, $T_j=25^\circ\text{C}$<br>V_GS=20V, I_D=16A, $T_j=175^\circ\text{C}$ | -<br>- | 160<br>238 | 240<br>- | mΩ<br>mΩ |
