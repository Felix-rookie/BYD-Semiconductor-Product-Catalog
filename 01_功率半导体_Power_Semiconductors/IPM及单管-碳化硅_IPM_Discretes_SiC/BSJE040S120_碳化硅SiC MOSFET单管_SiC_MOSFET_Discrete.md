...
**BSJE040S120** 是一款基于第三代宽禁带 **碳化硅 (SiC) MOSFET** 技术构建的高性能功率开关器件。采用平面栅 SiC MOSFET 工艺，具有极低的导通电阻、超低的开关损耗及卓越的高温工作能力。本产品严格符合 **AEC-Q101** 车规级标准，专为高效率电动汽车驱动系统与高频工业电源设计。
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **BSJE040S120** | 1200 V | 60 A | 40 mΩ | 175 °C | TO-263-7 |
...
| 体二极管正向电压 | V<sub>SD</sub> | V<sub>GS</sub> = 0 V, I<sub>F</sub> = 33 A | - | 3.4 | - | V |
