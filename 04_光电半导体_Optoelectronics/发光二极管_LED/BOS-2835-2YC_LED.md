...
**BOS-2835-2YC** 是一款基于AlGaInP工艺的车规级/工业级 SMD LED。该器件采用2835封装，具有黄色发光特性，适用于汽车照明、商业照明、信号灯、指示灯等应用场景。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=150mA | 2.2 | 150 | 590 | V |
| 发光强度 | IV | IF=150mA | — | 20 | — | mcd |
| 色坐标 | CHC | IF=150mA | — | — | — | — |
| 反向电流 | IR | VR=5V | — | — | 10 | μA |
