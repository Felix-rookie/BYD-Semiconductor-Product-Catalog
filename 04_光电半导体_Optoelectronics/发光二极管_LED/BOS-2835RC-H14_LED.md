...
**BOS-2835RC-H14** 是一款基于AlGaInP工艺的车规级/工业级 SMD LED。该器件采用2835封装，具有红色发光特性，适用于汽车照明、商业照明、信号灯、指示灯等应用场景。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=60mA | 2.4 | 5 | 1 | V |
| 发光强度 | IV | IF=60mA | — | — | — | mcd |
| 主波长 | λD | IF=60mA | 615 | 617 | 625 | nm |
| 反向电流 | IR | VR=5V | — | — | 10 | μA |
