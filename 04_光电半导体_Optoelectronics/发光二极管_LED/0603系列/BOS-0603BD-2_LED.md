...
**BOS-0603BD-2** 是一款基于—工艺的车规级/工业级 SMD LED。该器件采用0603封装，具有Iceland发光特性，适用于汽车照明、商业照明、信号灯、指示灯等应用场景。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=5mA | 2.6 | 2.9 | 3.4 | V |
| 发光强度 | IV | IF=5mA | — | 120 | — | mcd |
| 色坐标 | CHC | IF=5mA | — | — | — | — |
| 反向电流 | IR | VR=5V | — | — | 10 | μA |
