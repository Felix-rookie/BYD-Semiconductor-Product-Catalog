...
**BOS-0603GC** 是一款基于AlGaInP工艺的车规级/工业级 SMD LED。该器件采用0603封装，具有绿色发光特性，适用于汽车照明、商业照明、信号灯、指示灯等应用场景。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=5mA | 2.4 | 2.8 | 3.2 | V |
| 发光强度 | IV | IF=5mA | — | 90 | — | mcd |
| 主波长 | λD | IF=5mA | 516 | 522 | 531 | nm |
| 反向电流 | IR | VR=5V | — | — | 10 | μA |
