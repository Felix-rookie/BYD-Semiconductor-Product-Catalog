...
| 发光强度 | IV | IF=20mA | — | 900 | — | mcd |
| 主波长 | λD | IF=20mA | 627 | 632 | 636 | nm |
| 反向电流 | IR | VR=10V | — | — | 1 | μA |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=20mA | 1.9 | 2 | 2.2 | V |
| 光通量/光强 | φV / IV | IF=20mA | — | 900 | — | lm / mcd |
| 色坐标 x | x | IF=20mA | — | — | — | — |
| 色坐标 y | y | IF=20mA | — | — | — | — |
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| 寿命测试 | 工作寿命测试 | Ta=85±5℃, IF=50mA | 1000 Hrs | 22 | 0/22 |
