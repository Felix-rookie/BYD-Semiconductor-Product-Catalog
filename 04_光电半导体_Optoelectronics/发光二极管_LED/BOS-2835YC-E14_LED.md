...
**BOS-2835YC-E14** 是一款基于AlGaInP工艺的车规级/工业级 SMD LED。该器件采用2835封装，具有黄色发光特性，适用于汽车照明、商业照明、信号灯、指示灯等应用场景。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=60mA | 2.0 | 2.3 | 60 | V |
| 发光强度 | IV | IF=60mA | — | 12 | — | mcd |
| 色坐标 | CHC | IF=60mA | — | — | — | — |
