...
**BOS-2835-2RC** 是一款基于AlGaInP工艺的车规级/工业级 SMD LED。该器件采用2835封装，具有红色发光特性，适用于汽车照明、商业照明、信号灯、指示灯等应用场景。
...
### 🚗 典型应用 (Applications)
* .Car taillight 、Backlight for LCD,switch and etc.
