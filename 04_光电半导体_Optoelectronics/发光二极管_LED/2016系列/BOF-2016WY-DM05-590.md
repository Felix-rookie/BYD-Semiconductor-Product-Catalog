...
**BOF-2016WY-DM05-590** (采用陶瓷基板(Ceramic Substrate)工艺的高功率SMD LED)，采用 2.04×1.64×0.85mm SMD（陶瓷基板 Ceramic Substrate） 封装。黄色 发光，120° 视角，适用于 汽车照明、信号灯、指示灯等对可靠性要求极高的应用场景。
