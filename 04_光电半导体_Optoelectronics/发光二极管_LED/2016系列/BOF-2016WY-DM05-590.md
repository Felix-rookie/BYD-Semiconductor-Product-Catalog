# 比亚迪半导体 (BYD) LED - BOF-2016WY-DM05-590
...
**BOF-2016WY-DM05-590** (采用陶瓷基板(Ceramic Substrate)工艺的高功率SMD LED)，采用 2.04×1.64×0.85mm PLCC-2（陶瓷基板 Ceramic Substrate） 封装。黄色 发光，120° 视角，适用于 汽车仪表盘、指示灯、背光照明等应用场景。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=150mA | 2.6 | 3.0 | 3.3 | V |
| 光通量/光强 | φV / IV | IF=150mA | 26 | 30 | — | lm / mcd |
| 色坐标 x | x | IF=150mA | — | — | — | — |
| 色坐标 y | y | IF=150mA | — | — | — | — |
| 反向电流 | IR | VR=5V | — | — | 10 | μA |
