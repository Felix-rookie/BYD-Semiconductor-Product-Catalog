...
**BOF-2016SR-DMC** (采用陶瓷基板(Ceramic Substrate)工艺的高功率SMD LED)，采用 2.04×1.64×0.85mm SMD（陶瓷基板 Ceramic Substrate） 封装。Super 发光，130° 视角，适用于 汽车照明、信号灯、指示灯等对可靠性要求极高的应用场景。
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| 正向电压 | VF | IF=150mA | 1.6 | 2.0 | 2.4 | V |
| 光通量/光强 | φV / IV | IF=150mA | 12 | 18 | — | lm / mcd |
| 色坐标 x | x | IF=150mA | — | — | — | — |
| 色坐标 y | y | IF=150mA | — | — | — | — |
| 反向电流 | IR | VR=5V | — | — | 10 | μA |
