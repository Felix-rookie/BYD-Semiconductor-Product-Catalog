# 比亚迪半导体 (BYD) LED - BOF-2016WD-DY10-57
...
**BOF-2016WD-DY10-57** 是一款基于InGaN工艺的车规级/工业级 SMD LED。该器件采用2016封装，具有白色发光特性，适用于汽车照明、日行灯、雾灯等汽车级应用场景。
...
| 光通量 | φV | IF=150mA | 30 | 45 | — | lm |
| 色坐标 | CHC | IF=350mA | 0.303/0.291 | 0.323/0.323 | 0.342/0.355 | — |
| 反向电流 | IR | VR=5V | — | — | 10 | μA |
