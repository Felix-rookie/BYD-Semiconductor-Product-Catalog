...
**BOH-NWS3-60** 是一款基于InGaN工艺的**车规级高功率陶瓷基板SMD LED**。该器件采用5.0×5.0mm氮化铝(AlN)陶瓷基板封装，具有白色发光特性，专为**汽车前大灯(Headlamp)、日行灯(DRL)、雾灯(Fog Lamp)**等汽车级照明应用设计。
...
- 外形尺寸：5.0×5.0×0.8 mm
- 发光区域：1.0*3.2± 0.1 mm（陶瓷基板，双芯片并联）
- 公差：±0.2mm（除非另有说明）
...
- 文档编号：WI-D06F02-H-0035
- 版本号：Rev.A/1
- 原始PDF文件名：`BOH-NWS3-60-SPEC.pdf`
- 数据来源：比亚迪半导体官方技术文档
