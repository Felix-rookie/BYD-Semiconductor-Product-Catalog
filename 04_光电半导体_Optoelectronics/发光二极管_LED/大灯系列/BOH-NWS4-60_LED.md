...
**BOH-NWS4-60** 是一款基于InGaN工艺的**车规级高功率陶瓷基板SMD LED**。该器件采用5.0×5.0mm氮化铝(AlN)陶瓷基板封装，具有白色发光特性，专为**汽车前大灯(Headlamp)、日行灯(DRL)、雾灯(Fog Lamp)**等汽车级照明应用设计。
...
* **芯片材料**：InGaN
* **基板材料**：AlN（氮化铝）陶瓷基板
* **胶体类型**：Yellow Diffused（黄色扩散）— 软硅胶封装
* **符合RoHS标准**：环保无铅设计
* **MSL等级**：Level 2（JEDEC J-STD-020E）
* **ESD耐压**：≥8 kV（IEC-61000-4-2）
* **显色指数**：Ra ≥65
* **结温**：Tj ≤ 150℃
...
| 色温 | CCT | IF=1000mA | 5000 | 6000 | — | K |
| 色坐标 | CHC | IF=1000mA | 0.31/0.31 | 0.325/0.335 | 0.345/0.367 | — |
| 反向电流 | IR | VR=-5V | — | — | 5 | μA |
...
| 工作温度 | Topr | -40 ~ ++125 | °C |
| 储存温度 | Tstg | -40 ~ ++125 | °C |
| 热阻（结-板） | Rth(j-b) | 1.0 | K/W |
| ESD（IEC-61000-4-2） | ESD | ≥8 | kV |
| 焊接温度 | Tsol | 260°C for 10 Seconds | — |
...
- 外形尺寸：5.0×5.0×0.8 mm
- 发光区域：1.0*4.3± 0.1 mm（陶瓷基板，双芯片并联）
- 公差：±0.2mm（除非另有说明）
...
| :--- | :--- | :--- | :---: | :---: | :---: |
| 寿命测试 | 工作寿命测试 | Ta=85±5℃, IF=1000mA | 1000 Hrs | 11 | 0/11 |
| 寿命测试 | 高温高湿工作 | Ta=85±5℃, RH=85%, IF=1000mA | 1000 Hrs | 11 | 0/11 |
...
- 载带规格：12mm
- 卷盘规格：178mm
- 包装数量：500 / 1000 / 2000 pcs per reel（可选）
...
3. 保质期：12个月
4. 注意：LED 胶体为软硅胶封装，运输、装配时避免外力碰撞白色胶体和黄色荧光片

### 焊接
1. 回流焊不超过2次
2. 焊接时请勿对LED施加应力
3. 焊接后请勿弯曲电路板
4. PCB温度确保<125℃，测试点距离LED焊锡2mm内
...
- 文档编号：WI-D06F02-H-0036
- 版本号：Rev.A/1
- 原始PDF文件名：`BOH-NWS4-60-SPEC.pdf`
- 数据来源：比亚迪半导体官方技术文档
